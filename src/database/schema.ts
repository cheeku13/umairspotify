...
CREATE UNIQUE INDEX IF NOT EXISTS idx_albums_artist_title ON albums(artist_id, normalized_title);
...
CREATE TABLE IF NOT EXISTS tracks (
  ...
  import_status TEXT NOT NULL DEFAULT 'ready' CHECK(import_status IN ('pending', 'ready', 'failed', 'unsupported')),
  created_at INTEGER NOT NULL,
  updated_at INTEGER NOT NULL,
  FOREIGN KEY (artist_id) REFERENCES artists(id) ON DELETE RESTRICT,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_tracks_source_id ON tracks(source_id);
CREATE INDEX IF NOT EXISTS idx_tracks_title ON tracks(title COLLATE NOCASE);
CREATE INDEX IF NOT EXISTS idx_tracks_sort_title ON tracks(sort_title COLLATE NOCASE);
CREATE INDEX IF NOT EXISTS idx_tracks_artist ON tracks(artist_id, title COLLATE NOCASE);
CREATE INDEX IF NOT EXISTS idx_tracks_album ON tracks(album_id, track_number, title COLLATE NOCASE);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_artwork_hash ON artwork_cache(content_hash);
CREATE INDEX IF NOT EXISTS idx_artwork_album ON artwork_cache(album_id);
CREATE INDEX IF NOT EXISTS idx_artwork_accessed ON artwork_cache(last_accessed_at);
